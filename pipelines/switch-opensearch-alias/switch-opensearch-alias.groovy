node {
    ...
    stage("Switch alias") {
        ...
        data = "{\"actions\": [{\"remove\": {\"index\": \"books-${OLD_VERSION}\",\"alias\": \"books\"}},{\"add\": {\"index\": \"books-${NEW_VERSION}\",\"alias\":\"books\"}}]}"
        sh "curl -XPOST -H \"Content-Type:application/json\" http://opensearch:9200/_aliases -d $data"
    }
